...
mod arc_multi_op_tests {
    ...
    fn test_arc_multi_operator() {
        ...
        // Cél: kék (2) négyzet a jobb alsó sarokban + két piros (1) pixel a bal alsó sarokban
        ...
        let mut task = Task::builder("ARC multi-operator test")
        ...
        assert!(result.is_ok(), "ARC multi-operator task should succeed, got: {:?}", result.err());
